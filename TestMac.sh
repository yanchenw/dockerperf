...
if [ "$1" == "-v" ]; then
	...
	{ docker-compose -f src/MusicStore/bin/Release/netcoreapp1.0/publish/docker-compose.volume.mapped.yml up -d; waitForUrl http://localhost:35004; } | gnomon -t elapsed-total
	...
	{ docker-compose -f src/MusicStore/bin/Release/netcoreapp1.0/publish/docker-compose.yml up -d; waitForUrl http://localhost:35003; } | gnomon -t elapsed-total
